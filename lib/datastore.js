 ...
 *
 * @param {Function} options.databaseName
 * @param {Function} options.storeName
 *
...
function Datastore(options) {
  ...
  if (typeof options === 'string') {
    ...
    this.databaseName = options.databaseName || 'NeDB'
    this.storeName = options.storeName || 'nedbdata'
  }
